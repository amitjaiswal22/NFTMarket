...
const projectId="2QEiEt5rS1wgCXJTb9E0olpUcno"
const projectSecret="17a2976e5e887280cf15c9c6fb985945"
...
export default function CreateItem(){
  ...
  async function onChange(e){
    ...
    try{
      ...
      const url=`https://amit-nft.infura-ipfs.io/ipfs/${added.path}`
      setFileUrl(url)
    }catch(error){
